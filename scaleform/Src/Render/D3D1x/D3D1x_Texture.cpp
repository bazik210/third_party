...
{
    TextureManager* pmanager = GetManager();
    ID3D1x(DeviceContext)* pcontext = pmanager->pDeviceContext;
    ...
    pcontext->PSSetSamplers( stageIndex, 1, &sampler );
    pcontext->PSSetShaderResources( stageIndex, TextureCount, views );
}
