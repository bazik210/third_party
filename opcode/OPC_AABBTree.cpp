 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void AABBTreeNode::Release	(Opcode::allocator_type* m_allocator)
{
	// Opcode 1.3:
	const AABBTreeNode* Pos = GetPos();

#ifndef OPC_NO_NEG_VANILLA_TREE
	const AABBTreeNode* Neg =
#endif // #ifndef OPC_NO_NEG_VANILLA_TREE
		GetNeg();
#ifndef OPC_NO_NEG_VANILLA_TREE
	if(!(mPos&1))	DELETESINGLE(Pos);
	if(!(mNeg&1))	DELETESINGLE(Neg);
#else
	if(!(mPos&1))	DELETEARRAY( const_cast<AABBTreeNode*&>( Pos ) );
#endif
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
AABBTree::AABBTree(Opcode::allocator_type* allocator) : mIndices(null), mTotalNbNodes(0), mPool(null), m_allocator(allocator)
{
}
